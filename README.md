...
This repository contains a build of Kamcord for integrating into Unity 4.2+ games. The current version is 0.9.2 beta. Please visit the <a href="https://github.com/kamcord/kamcord-ios-sdk/wiki/Change-log">Change Log</a> to see a history of changes.
