...
void KamcordAndroid_WhitelistAll(JNIEnv* env);

void KamcordAndroid_BlacklistAll(JNIEnv* env);
...
void KamcordAndroid_WhitelistDevice(JNIEnv* env, const char* deviceName);

void KamcordAndroid_BlacklistDevice(JNIEnv* env, const char* deviceName);

void KamcordAndroid_WhitelistBoardOnSDK(JNIEnv* env, const char* boardName, int sdkVersion);

void KamcordAndroid_BlacklistBoardOnSDK(JNIEnv* env, const char* boardName, int sdkVersion);

void KamcordAndroid_WhitelistDeviceOnSDK(JNIEnv* env, const char* deviceName, int sdkVersion);

void KamcordAndroid_BlacklistDeviceOnSDK(JNIEnv* env, const char* deviceName, int sdkVersion);

const char* KamcordAndroid_GetBoard(JNIEnv* env);

const char* KamcordAndroid_GetDevice(JNIEnv* env);
...
void KamcordAndroid_SetDeveloperMetadata(
    JNIEnv* env,
    KC_METADATA_TYPE metadataType,
    const char* key,
    const char* value);

void KamcordAndroid_SetDeveloperMetadataWithNumericValueDouble(
    JNIEnv* env,
    KC_METADATA_TYPE metadataType,
    const char* key,
    const char* value,
...
void KamcordAndroid_SetDeveloperMetadataWithNumericValueFloat(
    JNIEnv* env,
    KC_METADATA_TYPE metadataType,
    const char* key,
    const char* value,
...
void KamcordAndroid_SetDeveloperMetadataWithNumericValueInt(
    JNIEnv* env,
    KC_METADATA_TYPE metadataType,
    const char* key,
    const char* value,
